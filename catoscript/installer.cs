...
if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
{
    ...
    static async void httpdownload(string url, string file)
    {
    ...
    Console.WriteLine("Welcome to CatoScript Dev 0.1.4 Installer and modifier! Press any key to start");
    Console.ReadKey();
    if (File.Exists("cato.exe") == false)
    {
        ...
        try
        {
            httpdownload("https://github.com/catocodedev/catoscript/releases/download/Dev0.1.4/cato.exe", "cato.exe");
        }
        catch (Exception ex)
        {
    ...
    else
    {
        ...
        Console.WriteLine("[2] - Update cato script to Dev 0.1.4");
        Console.ReadKey();
        Console.Clear();
        if (Console.ReadKey(true).Key == ConsoleKey.D1)
        {
        ...
        else if (Console.ReadKey(true).Key == ConsoleKey.D2)
        {
            ...
            try
            {
                ...
                myWebClient.DownloadFile("https://github.com/catocodedev/catoscript/releases/download/Dev0.1.4/cato.exe", "cato.exe");
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.ToString());
...
{
    Console.WriteLine("Catoscript installer doesn't support your OS! Catoscript could still support your OS.");
}
    Console.ReadKey();
